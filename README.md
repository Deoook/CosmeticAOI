...
- Class 구조 설계
- Matrox MIL 프레임 그래버를 통해 Grab 된 영상 데이터를 처리하고 외관 검사 수행 후 결과를 실시간 시각화
- 검사 정확도 향상을 위한 기준점 설정 기능 구현 (Calibration)
- 160개 포지션 별로 조명 값을 달리 적용할 수 있도록 시리얼 통신(RS232) 기반 스트로브 제어 기능 구현
- MS-SQL 이용 검사 결과 저장 및 REPORT, DASHBOARD 기능 구현
